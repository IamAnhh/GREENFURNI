...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, CommonModule, RouterLink, RouterModule, HeaderComponent, FooterComponent],
...
export class AccountComponent implements OnInit{
  ...
  //   DISCOUNT
    ...
    // Truy xuất các chứng từ được hiển thị từ sessionStorage
    ...
    // Lấy usedStatus từ sessionStorage
